...
if __name__ == "__main__":
    ...
    json_fname = tester.next_path(DATA_FNAME, "json")
    plt_fname = tester.next_path(DATA_FNAME, "png")
    ...
    tester.graph_data(trials, np_thresh, np_loss, np_draw, np_win, ranks, frequencies, plt_fname)
